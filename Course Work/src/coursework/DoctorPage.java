...
public class DoctorPage {
    ...
    public static String doctor_checking() throws IOException {
        ...
        String[] words;
        FileReader fr = new FileReader("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\doctor's_data.txt");
    ...
    public static String doctor() throws IOException {
        ...
        switch (number_of_menu) {
            ...
            case "1" -> {
                ...
                String txt_path = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\patient's_data.txt";
                BufferedWriter bw = new BufferedWriter(new FileWriter(txt_path, true));
                bw.write("\n" + first_name + last_name);
                bw.close();

                FileInputStream file = new FileInputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\patients.xlsx");
...
//      third
                FileInputStream file3 = new FileInputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\medical_histories.xlsx");
...
//      fourth
                FileInputStream file4 = new FileInputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\procedures.xlsx");
                ...
                FileOutputStream output_file = new FileOutputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\patients.xlsx");
                xwb.write(output_file);
                output_file.close();

                FileOutputStream output_file3 = new FileOutputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\medical_histories.xlsx");
                xwb3.write(output_file3);
                output_file3.close();

                FileOutputStream output_file4 = new FileOutputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\procedures.xlsx");
            ...
            case "2" -> {
                ...
                String path = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assignments.xlsx";
                ...
                for (Row row : sheet) {
                    ...
                    for (Cell cell : row) {
                        ...
                        switch (formulaEvaluator.evaluateInCell(cell).getCellType()) {
                            ...
                            case NUMERIC -> System.out.printf("%-55s",cell.getNumericCellValue());
                            case STRING -> System.out.printf("%-55s",cell.getStringCellValue());
                        }
                    }
                ...
                for (Row row : sheet) {
                    ...
                    for (Cell cell : row) {
                        ...
                        switch (formulaEvaluator.evaluateInCell(cell).getCellType()) {
                            ...
                            case NUMERIC -> System.out.printf("%-50s",cell.getNumericCellValue());
                            case STRING -> System.out.printf("%-50s",cell.getStringCellValue());
                        }
                    }
            ...
            case "4" -> {
                ...
                String path = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\patients.xlsx";
                ...
                File file = new File("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\patient's_data.txt");
                ...
                String path2 = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\medical_histories.xlsx";
                ...
                String path3 = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\procedures.xlsx";
            ...
            case "5" -> {
                ...
                FileInputStream file = new FileInputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assignments.xlsx");
                XSSFWorkbook xwb = new XSSFWorkbook(file);
                XSSFSheet sheet = xwb.getSheet("Assignments");
                ...
                FileOutputStream output_file =new FileOutputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assignments.xlsx");
                xwb.write(output_file);
                output_file.close();
                System.out.println("""
                                                ...
                                                for (Row row2 : personal_sheet) {
                                                    ...
                                                    for (Cell cell2 : row2) {
                                                        ...
                                                        switch (formulaEvaluator.evaluateInCell(cell2).getCellType()) {
                                                            ...
                                                            case NUMERIC -> System.out.printf("%-30s",cell2.getNumericCellValue() );
                                                            case STRING -> System.out.printf("%-30s",cell2.getStringCellValue() );
                                                        }
                                                    }
                                                    System.out.println();}}
