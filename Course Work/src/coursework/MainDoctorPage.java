...
public class MainDoctorPage {
    ...
    public static String main_doctor_checking() throws IOException {
        ...
        String[] words;
        FileReader fr = new FileReader("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\main_doctor's_data.txt");
    ...
    public static String main_doctor() throws IOException {
        ...
        switch (number_of_menu) {
            ...
            case "1" -> {
                ...
                switch (type_of_account) {
                    ...
                    case "1" -> {
                        ...
                        String txt_path = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assistant's_data.txt";
                        BufferedWriter bw = new BufferedWriter(new FileWriter(txt_path, true));
                        bw.write("\n" + first_name + last_name);
                        bw.close();

                        FileInputStream file = new FileInputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assistants.xlsx");
                        ...
                        FileOutputStream output_file = new FileOutputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assistants.xlsx");
                    ...
                    case "2" -> {
                        ...
                        String txt_path = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\doctor's_data.txt";
                        BufferedWriter bw = new BufferedWriter(new FileWriter(txt_path, true));
                        bw.write("\n" + first_name + last_name);
                        bw.close();

                        FileInputStream file = new FileInputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\doctors.xlsx");
                        ...
                        FileInputStream file3 = new FileInputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\d_schedule.xlsx");
                        ...
                        FileOutputStream output_file = new FileOutputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\doctors.xlsx");
                        xwb.write(output_file);
                        output_file.close();

                        FileOutputStream output_file3 = new FileOutputStream("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\d_schedule.xlsx");
            ...
            case "2" -> {
                ...
                String path = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assistants.xlsx";
            ...
            case "3" -> {
                ...
                switch (type_of_account) {
                    ...
                    case "1" -> {
                        ...
                        File file = new File("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assistant's_data.txt");
                    ...
                    case "2" -> {
                        ...
                        String path = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\doctors.xlsx";
                        ...
                        File file = new File("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\doctor's_data.txt");
                        ...
                        String path2 = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\d_schedule.xlsx";
                ...
                for (Row row : sheet) {
                    ...
                    for (Cell cell : row) {
                        ...
                        switch (formulaEvaluator.evaluateInCell(cell).getCellType()) {
                            ...
                            case NUMERIC -> System.out.printf("%-20s",cell.getNumericCellValue());
                                                ...
                                                for (Row row2 : personal_sheet2) {
                                                    ...
                                                    for (Cell cell2 : row2) {
                                                        ...
                                                        switch (formulaEvaluator.evaluateInCell(cell2).getCellType()) {
                                                            ...
                                                            case NUMERIC -> System.out.printf("%-20s",cell2.getNumericCellValue());
                                                            case STRING -> System.out.printf("%-20s",cell2.getStringCellValue());
                                                                }
                                                            }
                                                            System.out.println();}}
