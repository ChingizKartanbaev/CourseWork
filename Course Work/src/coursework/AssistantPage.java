...
public class AssistantPage {
    ...
    public static String assistant_checking() throws IOException {
        ...
        String[] words;
        FileReader fr = new FileReader("C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\assistant's_data.txt");
    ...
    public static String assistant() throws IOException {
        ...
        switch (number_of_menu) {
            ...
            case "4" -> {
                ...
                String path = "C:\\Users\\User\\IdeaProjects\\Course Work (Java)\\Course Work\\files\\procedures.xlsx";
